...
#CACHEDIR="/home/ubuntu/workspace/docker/commonera-utopic/test-cache" # Change this to place the cache somewhere else
...
[ -z ${RUNNING_DRUN} ] && {
  ...
  CONTAINER_IMAGE='commonera/proxy-cache:utopic'
